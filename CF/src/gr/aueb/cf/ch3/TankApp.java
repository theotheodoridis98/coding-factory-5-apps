...
/**
 * Λαμβάνει ως είσοδο true/false
 * από το stdio, για δύο δεξαμενές καυσίμων ενός
 * αεροπλάνου εάν τα καύσιμα είναι κάτω απο 1/4.
 * Επεξεργάζεται, και αν η μία δεξαμενή είναι <1/4 ανάβει
 * η πορτοκαλί ένδειξη, αν και οι δύο είναι <1/4 ανάβει
 * η κόκκινη ένδειξη.
 */
